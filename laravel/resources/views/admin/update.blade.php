        ...
        <section class="content">
            <div class="card card-info card-outline">
              <div class="card-header">
                <form action="{{ route('boardgame.update',$boardgames->id) }}" method="post" enctype='multipart/form-data'>
                  {{@csrf_field()}}
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                      <button type="submit" name="btnUbah" class="btn btn-success"> Update data </button>
                  </div>
                </form>
              </div>
            </div>
